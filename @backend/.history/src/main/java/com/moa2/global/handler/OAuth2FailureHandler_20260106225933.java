...
public class OAuth2FailureHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    private String getErrorMessage(String errorCode, String errorDescription) {
        return switch (errorCode) {
            ...
            case "invalid_token_response" -> "토큰 응답을 처리하는 중 오류가 발생했습니다. 카카오 로그인 설정을 확인해주세요.";
            case "server_error" -> "OAuth2 서버 오류가 발생했습니다. 잠시 후 다시 시도해주세요.";
            case "temporarily_unavailable" -> "OAuth2 서비스가 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도해주세요.";
            default -> {
