...
public class AdminUserController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<UserDto.UserListResponse>>> getUserList(
        ...
        Page<UserDto.UserListResponse> pageResult = adminUserService.getUserList(keyword, sort, pageable);
        PageResponse<UserDto.UserListResponse> result = PageResponse.of(pageResult);
